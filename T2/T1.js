...
var comunas_IV = new Array("-", "Andacollo", "Canela", "Combarbalá", "Coquimbo", "Illapel", "La Higuera", "La Serena", "Los Vilos", "Mincha", "Monte Patria", "Ovalle", "Paihuano", "Punitaqui", "Río Hurtado", "Salamanca", "Vicuña");
...
var comunas_XV = new Array("-", "Arica", "Camarones", "Gral. Lagos", "Putre");
...
const myChart = new Chart(ctx1, {
    ...
    data: {
        ...
        datasets: [{
            ...
            //variable que llama a la consulta, recupera la parte del inicio-actividad guardandola en una lista
            //luego, con un for se recorre esa lista y por cada elemento se suma 1 a algún contador y se pone ese contador como 
    ...
    Swal.fire({
        ...
        if (result.isConfirmed && validar() == true) {
            Swal.fire({
                ...
                window.location = "cgi-bin/home.py";
